...
The developers thank all the open source libraries making GEMSEO-pymoo possible.

External Dependencies
---------------------

GEMSEO-pymoo depends on software with compatible licenses that are listed below.
...
GEMSEO-pymoo source code includes software with compatible licenses that are listed below.
